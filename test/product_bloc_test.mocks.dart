...
// in unit_testing_scenarios/test/product_bloc_test.dart.
...
import 'package:unit_testing_scenarios/models/product.dart' as _i4;
...
class MockProductRepository extends _i1.Mock implements _i2.ProductRepository {
  ...
  @override
  _i3.Future<void> toggleFavorite(_i4.Product? product) => (super.noSuchMethod(
        Invocation.method(
          #toggleFavorite,
          [product],
        ),
