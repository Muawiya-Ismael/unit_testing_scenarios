...
// in unit_testing_scenarios/test/auth_service_test.dart.
...
import 'package:unit_testing_scenarios/models/auth_api_client.dart' as _i2;
import 'package:unit_testing_scenarios/models/secure_storage.dart' as _i5;
...
class MockAuthApiClient extends _i1.Mock implements _i2.AuthApiClient {
  ...
  @override
  _i3.Future<void> logout(String? token) => (super.noSuchMethod(
        Invocation.method(
          #logout,
          [token],
        ),
